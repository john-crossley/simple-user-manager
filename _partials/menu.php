                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php if ($user->checkPermission('accessAdminPanel')): ?>
                                <li><a href="<?php echo root_path('admin/'); ?>"><i
                                            class="glyphicon glyphicon-home"></i> Admin Panel</a></li>
                            <?php endif; ?>
                            <li><a href="<?php echo root_path('member/'); ?>"><i
                                        class="glyphicon glyphicon-list-alt"></i> Member Panel</a></li>
                            <li><a href="<?php echo root_path('profile.php'); ?>"><i
                                        class="glyphicon glyphicon-user"></i> Profile</a></li>
                            <?php if (pm_system_enabled()): ?>
                                <?php if ($user->receive_personal_messages > 0): ?>
                                    <li><a href="<?php echo root_path('messages.php'); ?>"><i
                                                class="glyphicon glyphicon-envelope"></i> Messages
                                            <span
                                                class="badge badge-important"><?php echo count_messages($user->id); ?></span></a>
                                    </li>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if ($user->checkPermission('accessSettingsPanel')): ?>
                                <li>
                                    <a href="<?php echo root_path('admin/settings.php'); ?>"><i
                                            class="glyphicon glyphicon-cog"></i> Settings</a>
                                </li>
                            <?php endif; ?>
                            <li class="divider"></li>
                            <li><a href="<?php echo root_path('logout.php'); ?>"><i
                                        class="glyphicon glyphicon-lock"></i> Logout <?php echo $user->username ?></a>
                            </li>
                        </ul>
                    </li>
                <?php else: ?>
