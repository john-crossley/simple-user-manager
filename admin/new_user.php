...
<div class="col-sm-3 col-md-2 sidebar">
    <?php get_admin_sidebar('new-user'); ?>
</div>
    ...
    <form method="post" action="<?= root_path("admin/new_user.php") ?>" class="form-new-user">
        ...
        <div class="form-group has-<?= form_has_error('fullname') ?>">
            ...
            <input type="text" class="form-control" id="fullname" name="fullname"
                   placeholder="Enter the members full name" value="<?= form_has_value('fullname') ?>">
        ...
        <div class="form-group has-<?= form_has_error('redirect_to') ?>">
            ...
            <input type="text" class="form-control" id="redirect_to" name="redirect_to"
                   placeholder="Enter redirect location" value="<?= form_has_value('redirect_to') ?>">
            <small
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="member-status" name="roleId">
                ...
                <?php foreach (Role::getSystemUserGroups() as $group): ?>
                    <option
                        value="<?= $group->role_id ?>" <?= status(default_permission(), $group->role_id) ?>><?= $group->role_name ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <!--//.form-group-->
        ...
        <div class="form-group">
            ...
            <a href="<?= root_path('admin/') ?>" class="btn btn-danger"
               onclick="return confirm('Are you sure? Unsaved changes will be lost!');">Cancel</a>
        </div>
        <!--//.form-group-->
