...
<div class="col-sm-3 col-md-2 sidebar">
    <?php get_admin_sidebar('templates'); ?>
</div>
    ...
    <form action="<?= root_path('admin/templates.php') ?>" method="post">
        ...
        <div class="form-group has-<?= form_has_error('template_subject') ?>">
            ...
            <input type="text" class="form-control" id="template_subject" name="template_subject"
                   placeholder="Enter the email subject" value="<?= form_has_value('template_subject') ?>">
        ...
        <div class="form-group has-<?= form_has_error('template_data') ?>">
            ...
            <span class="help-block"><?=
                form_has_message('template_data', "Some default data:
