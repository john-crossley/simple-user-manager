...
ensure_login();
$user = get_user();
check_user_access($user, 'viewUserGroups', array(
    'redirect' => 'admin/'
));
...
<div class="col-sm-3 col-md-2 sidebar">
    <?php get_admin_sidebar('view-groups'); ?>
</div>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <p>The <strong>ACL</strong> was built to give you full control over what
        ...
        <br>The groups are <strong>Administrator</strong>, <strong>Member</strong> and <strong>Banned</strong>.
    </p>
    ...
    <form method="post" action="<?= root_path('admin/user_groups.php') ?>">
        <div class="form-group">
            ...
            <small class="help-block">
                <button type="submit" name="delete" onclick="return confirm('Delete this Role?');"
                        class="btn btn-danger btn-xs pull-right">Delete Group
                </button>
            </small>
        </div>
        <!--//.form-group-->
