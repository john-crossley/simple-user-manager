...
# Generation Time: 2014-03-21 20:13:16 +0000
# ************************************************************
...
CREATE TABLE `setting` (
  ...
  `email_on_register` tinyint(1) DEFAULT '0',
...
INSERT INTO `setting` (`id`, `name`, `url`, `version`, `meta_author`, `meta_description`, `banned_email_extensions`, `default_group`, `allow_registration`, `email`, `pm_disabled`, `email_on_register`, `username_disabled`)
VALUES
  (1,'Simple User Manager','http://localhost/simple-user-manager/','1.2.1','John Crossley','This is a meta description, nothing too fancy just this.','fake.com example.com googlemail.com',2,1,'jonnysnip3r@gmail.com',1,1,0);
...
VALUES
  ...
  (8,'New User Registered','New User Registered','Hello {{admin_name}},\n\r\nJust to let you know a new member (called {{username}}) has just registered.\n\nPs. You can disable this email or change the contents over in the admin panel.\r\n\r\nKind Regards,\r\n\r\n{{system_name}} team','a:1:{s:14:\"admin_name\";s:8:\"username\";}',NULL);
...
VALUES
  (1,'John','Crossley','admin','jonnysnip3r@gmail.com','Hello my name is John Crossley and I\'m a 24 year old student / web app developer from Manchester, England. I specialise in writing beauiful php, HTML, CSS and JavaScript oh and a little bit of Ruby. If your looking for someone to write awesome code for you, your company or even your dog then then I\'m your guy!','Manchester, England','0643c76c544072ea70d1f869d1b45cb45c3771a3','439313a160fb70949d073a266455d6d4a38c7c72',0,0,1,0,'admin/index.php','2013-05-26 21:45:48','2014-03-21 20:07:45','2014-03-21 20:07:45',1,'1cac65fc4cfba6bd576f9e028e47840d',''),
