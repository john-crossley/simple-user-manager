        ...
        <div class="col-md-3">
            <div class="thumbnail">
                <img src="<?php echo get_profile_picture($user, 240) ?>" width="240" height="240" class="gravatar"
                     alt="<?php echo $user->username; ?>'s Profile Picture">
                <div class="caption">
                    <hgroup>
                    ...
                    <p><i class="glyphicon glyphicon-envelope"></i> <a
                            href="mailto: <?php echo $user->email; ?>"><?php echo $user->email; ?></a></p>
                    <p><i class="glyphicon glyphicon-map-marker"></i> <?php echo $user->location; ?></p>
                    <p><i class="glyphicon glyphicon-time"></i> Joined
                        on: <?php echo date(TIME_FORMAT, strtotime($user->created_at)) ?></p>
                </div>
            </div>
        </div>

        <div class="col-md-9">
            <h2>Viewing <?php echo fullname($user); ?>'s Profile</h2>
            <hr>

            <form method="post" action="<?php echo root_path('profile.php'); ?>" enctype="multipart/form-data">
                <div class="form-group has-<?php echo form_has_error('username'); ?>">
                    ...
                    <small class="help-block"><?php echo form_has_message('username'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('fullname'); ?>">
                    <label for="fullname" class="control-label">Full name</label>
                    <input type="text" class="form-control" id="fullname" name="fullname"
                           placeholder="Enter the members full name" value="<?php echo fullname($user); ?>">
                    <small class="help-block"><?php echo form_has_message('fullname'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('email'); ?>">
                    <label for="email" class="control-label">Email address</label>
                    <input type="email" class="form-control" id="email" name="email"
                           placeholder="Enter a valid email address" value="<?php echo $user->email; ?>">
                    <small class="help-block"><?php echo form_has_message('email'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('password'); ?>">
                    <label for="password" class="control-label">Password</label>
                    <input type="password" class="form-control" id="password" name="password"
                           placeholder="Enter a password">
                    <small class="help-block"><?php echo form_has_message('password'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('password_again'); ?>">
                    <label for="password_again" class="control-label">Password again</label>
                    <input type="password" class="form-control" id="password_again" name="password_again"
                           placeholder="Enter a password">
                    <small class="help-block"><?php echo form_has_message('password_again'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('bio'); ?>">
                    <label for="bio" class="control-label">Bio</label>
                    <textarea class="form-control" id="bio" name="bio" cols="0" rows="0"><?php echo $user->bio ?></textarea>
                    <small class="help-block"><?php echo form_has_message('fullname'); ?></small>
                </div>
                <!--//.form-group-->

                <div class="form-group has-<?php echo form_has_error('current_location'); ?>">
                    ...
                    <input type="text" class="form-control" id="current_location" name="current_location"
                           placeholder="Enter the users location" value="<?php echo $user->location ?>">
                    <small class="help-block"><?php echo form_has_message('current_location'); ?></small>
                </div>
                <!--//.form-group-->
                ...
                <div class="form-group">
                    ...
                    <small class="help-block">
                        ...
                        <?php if ($user->custom_image): ?>
                            <a href="<?php echo $image_url ?>" target="_blank"><?php echo $image_url ?></a>
                        <?php endif; ?>
                    </small>
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="account_private" <?php echo is_checked($user->private) ?>>
                ...
                <?php if (pm_system_enabled()): ?>
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"
                                       name="personal_message" <?php echo is_checked($user->notify_me_personal_message) ?>>
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"
                                       name="receive_personal_messages" <?php echo is_checked($user->receive_personal_messages) ?>>
